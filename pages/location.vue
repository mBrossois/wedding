<template>
    ...
    <div class="tablet-double-column">
        <NuxtImg class="image castle" loading="lazy" src="https://res.cloudinary.com/dt7uhy7jv/image/upload/f_auto,q_auto/v1/wedding/vaeshartelt-castle" alt="Castle Vaeshartelt" height="677" width="1000"/>
        <div>
        ...
        <div class="flex flex-column gap-2">
            ...
            <NuxtImg class="image terrain" loading="lazy" src="https://res.cloudinary.com/dt7uhy7jv/image/upload/f_auto,q_auto/v1/wedding/map-terrain" alt="Map terrain" height="723" width="1000" @click="openModal()"/>
        </div>
    </div>

    <AppModal class="modal-container" :isOpen="modalOpen" :title="$t('MAP_TERAIN')" :buttons="[]" size="full" @onClose="closeModal()">
        <NuxtImg class="image terrain full" loading="lazy" src="https://res.cloudinary.com/dt7uhy7jv/image/upload/f_auto,q_auto/v1/wedding/map-terrain" alt="Map terrain" height="723" width="1000"/>
    </AppModal>
</template>
